...
# The Debian sysroot for arm64, installed by the build workflow into
...
file(GLOB LINUX_SYSROOT
    ...
    "${CMAKE_CURRENT_LIST_DIR}/../dependencies/webrtc/linux/debian*arm64*"
)
if(NOT LINUX_SYSROOT)
    message(FATAL_ERROR "No debian arm64 sysroot found in /opt/sysroot or dependencies/webrtc/linux, run dependencies/webrtc/linux/sysroot/install-sysroot.py --arch=arm64")
endif()
